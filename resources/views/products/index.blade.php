                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="bg-white">
                        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                            <h2 class="text-2xl font-bold tracking-tight text-gray-900">Liste des produits</h2>
                            <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">

                                @foreach ($products as $product)
                                    <div class="group relative">

                                        <div class="rounded-lg border border-gray-100 shadow-md flex-col overflow-hidden flex w-full relative bg-white max-w-md">
                                            <a class="rounded-xl flex mx-3  mt-3 overflow-hidden relative" href="#">
                                            ...
                                            <div class="mt-4 px-5 pb-5">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="text-sm text-slate-900 line-through">${{ $product->regular_price }}</span>
                                                </p>
